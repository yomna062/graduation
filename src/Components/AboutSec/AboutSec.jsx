        ...
        <div className='bg-blue-100 py-10'>
            ...
            <div className="about-text text-center max-w-xl mx-auto py-8 ">
                ...
                <p className='text-gray-600 leading-relaxed'>
                    Lorem ipsum dolor sit amet consectetur. Morbi dolor eros non ullamcorper nunc sagittis. Faucibus tempus id quam ac nam luctus massa. Sem quam ultrices mauris nulla. Commodo fermentum vulputate id adipiscing auctor proin sagittis aliquam porttitor.
                </p>
            </div>
